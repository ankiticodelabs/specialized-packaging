        ...
        return (
          <>
            <Form className={classes} onSubmit={handleSubmit}>
              ...
              <H3>We'd love to list your company! Please tell us more</H3>
              ...
              <div className={css.fieldWrapper}>
                <FieldTextInput
                  ...
                  validate={composeValidators(
                    required(<FormattedMessage id="ContactUsForm.companyNameRequired" />)
                  )}
                />
                <FieldTextInput
                  id="websiteName"
                  ...
                  className={css.inputBox}
                  validate={composeValidators(
                    required(<FormattedMessage id="ContactUsForm.websiteNameRequired" />)
                  )}
                />
              </div>
              <FieldTextInput
                ...
                validate={composeValidators(
                  required(<FormattedMessage id="ContactUsForm.phoneNumberRequired" />)
                )}
              />
              <FieldTextInput
                id="typeofPacking"
                ...
                className={css.singleInput}
                validate={composeValidators(
                  required(<FormattedMessage id="ContactUsForm.typeofPackingRequired" />)
                )}
              />
              <FieldTextInput
                id="problemToSolve"
                ...
                className={css.singleInput}
                validate={composeValidators(
                  required(<FormattedMessage id="ContactUsForm.problemToSolveRequired" />)
                )}
              />
