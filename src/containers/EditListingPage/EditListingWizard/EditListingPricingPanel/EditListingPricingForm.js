      ...
      return (
        <Form onSubmit={handleSubmit} className={classes}>
          ...
          {/* <FieldTextInput
            ...
            autoComplete="minMOQ"
            label={intl.formatMessage({
              id: 'ConfirmSignupForm.minMOQLabel',
            })}
            placeholder={intl.formatMessage({
              id: 'ConfirmSignupForm.minMOQPlaceholder',
            })}
            // initialValue={email}
          ...
          <FieldTextInput
            type="number"
            id={formId ? `${formId}.maxMOQ` : 'maxMOQ'}
            name="maxMOQ"
            className={css.inputBox}
            autoComplete="maxMOQ"
            label={intl.formatMessage({
              id: 'ConfirmSignupForm.maxMOQLabel',
            })}
            placeholder={intl.formatMessage({
              id: 'ConfirmSignupForm.maxMOQPlaceholder',
            })}
          />
          <FieldTextInput
            type="text"
            className={css.inputBox}
            id={formId ? `${formId}.minLeadTime` : 'minLeadTime'}
            name="minLeadTime"
            autoComplete="minLeadTime"
            label={intl.formatMessage({
              id: 'ConfirmSignupForm.minLeadTimeLabel',
            })}
            placeholder={intl.formatMessage({
              id: 'ConfirmSignupForm.minLeadTimePlaceholder',
            })}
          />
          <FieldTextInput
            type="text"
            id={formId ? `${formId}.maxLeadTime` : 'maxLeadTime'}
            name="maxLeadTime"
            className={css.inputBox}
            autoComplete="maxLeadTime"
            label={intl.formatMessage({
              id: 'ConfirmSignupForm.maxLeadTimeLabel',
            })}
            placeholder={intl.formatMessage({
              id: 'ConfirmSignupForm.maxLeadTimePlaceholder',
            })}
          />
          <FieldTextInput
            type="number"
            id={formId ? `${formId}.maxWidth` : 'maxWidth'}
            name="maxWidth"
            className={css.inputBox}
            autoComplete="maxWidth"
            label={intl.formatMessage({
              id: 'ConfirmSignupForm.maxWidthLabel',
            })}
            placeholder={intl.formatMessage({
              id: 'ConfirmSignupForm.maxWidthPlaceholder',
            })}
          />
          ...
          <FieldSelect
            ...
            name="colors"
            label={intl.formatMessage({ id: 'EditListingPricingForm.colorOptionsLabel' })}
            // validate={validators.required(
            //   intl.formatMessage({ id: 'EditListingPricingForm.colorOptionsRequired' })
            // )}
          >
            <option disabled value="">
              {intl.formatMessage({ id: 'EditListingPricingForm.selectColorOption' })}
            </option>
            {[...Array(10)].map((_, i) => {
              const value = i + 1;
              return (
                <option key={value} value={value}>
                  {`Up to ${value} colour${value > 1 ? 's' : ''}`}
                </option>
              );
            })}
          </FieldSelect> */}
